...
@endif
<form action="{{ route($object.'.update',['id'=>$type->id]) }}" enctype="multipart/form-data" method="post">
    @csrf
                ...
                <div class="row">
                    <div class="col-sm-6 col-12">
                        <div class="mb-3">
                            ...
                            <input value="{{ $type->name }}" name="name" type="text" class="form-control" placeholder="Nhập tên {{ $object_title }}" autocomplete="off">
                            @error('name')
