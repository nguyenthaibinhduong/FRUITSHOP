                ...
                <div class="row">
                    <div class="col-sm-12 col-12">
                        <div class="mb-3">
                            ...
                            <input value="{{ $user->name }}" name="name" type="text" class="form-control" placeholder="Nhập tên {{ $object_title }}" autocomplete="off">
                            @error('name')
                    ...
                    <div class="col-sm-12 col-12">
                        <div class="mb-3">
                            ...
                            <input value="{{ $user->email }}" name="email" type="text" class="form-control" placeholder="Nhập Email" autocomplete="off">
                            @error('email')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-sm-12 col-12">
                        <div class="mb-3">
                            ...
                            <select multiple class="form-control" size="{{ $roles->count() }}" name="role[]"  placeholder="Chọn vai trò {{ $object_title }}">
                                ...
                                <option {{ ($getAllRolesOfUser->contains($role->id))?"selected":"" }} value="{{ $role->id }}">{{ $role->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
